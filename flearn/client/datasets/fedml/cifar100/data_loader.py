...
def get_dataloader(dataset, datadir, train_bs, test_bs, dataidxs=None, num_workers=0):
    return get_dataloader_CIFAR100(datadir, train_bs, test_bs, dataidxs, num_workers=num_workers)
...
def get_dataloader_test_CIFAR100(datadir, train_bs, test_bs, dataidxs_train=None, dataidxs_test=None, num_workers=0):
    dl_obj = CIFAR100_truncated
...
def load_partition_data_distributed_cifar100(
    ...
    if process_id == 0:
        train_data_global, test_data_global = get_dataloader(
            dataset, data_dir, batch_size, batch_size, num_workers=num_workers
        )
