...
class LeNet5Client(nn.Module):
    def __init__(self, num_classes):
        super(LeNet5Client, self).__init__()
...
class ResNet_cifarClient(ResNetBase):
    def __init__(
        self,
        dataset,
        resnet_size,
        ...
        super(ResNet_cifarClient, self).__init__()
        self.dataset = dataset
        self.freeze_bn = freeze_bn
        self.freeze_bn_affine = freeze_bn_affine
...
class ResNet_cifarServer(ResNetBase):
    def __init__(
        self,
        dataset,
        resnet_size,
        ...
        super(ResNet_cifarServer, self).__init__()
        self.dataset = dataset
        self.freeze_bn = freeze_bn
        self.freeze_bn_affine = freeze_bn_affine
        self.num_classes = self._decide_num_classes()
